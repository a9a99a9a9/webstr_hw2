...
import Popular from './app/components/home/popular/Popular'; // Popular 컴포넌트 import
import Search from './app/components/home/search/Search'; // Search 컴포넌트 import
import './App.css';
      ...
      <TransitionGroup>
        <CSSTransition timeout={300} classNames="fade" unmountOnExit>
          <Routes>
            ...
            <Route path="/popular" element={isAuthenticated ? <Popular /> : <Navigate to="/signin" replace />} />
            <Route path="/search" element={isAuthenticated ? <Search /> : <Navigate to="/signin" replace />} /> {/* Search 페이지 경로 추가 */}
          </Routes>
        </CSSTransition>
      </TransitionGroup>
    </Router>
